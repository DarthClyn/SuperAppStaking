...
router.get('/:user_id', async (req, res) => {
    ...
    const userStakes = await models_1.Stake.find({ user_id, status: 'STAKED' });
    let accrued = 0;
...
router.post('/claim', async (req, res) => {
    ...
    for (const stake of userStakes) {
        ...
        await models_1.Stake.update({ stake_id: stake.stake_id }, { last_claimed: now, total_redeemed: newTotalRedeemed });
    }
